"""
eval_msgla_benchmarks.py — Benchmark evaluation for MS-GLA checkpoints in DCP format.
...
Examples:
    python eval_msgla_benchmarks.py \
...
def main():
    parser = argparse.ArgumentParser(
        description="Evaluate MS-GLA checkpoints on WikiText/LAMBADA/PIQA/HellaSwag/WinoGrande"
    )
    parser.add_argument(
        "--checkpoint_path",
        required=True,
