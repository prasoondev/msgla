"""
eval_dcp.py — Zero-shot recall evaluation for MS-GLA checkpoints in DCP format.
Evaluates on SWDE (Accuracy), FDA (F1), and SQUAD (F1).

Examples:
    python eval_dcp.py --checkpoint_path /path/to/exp/msgla-340M --step 10800 --model_ref /path/to/exp/msgla-340M
    python eval_dcp.py --checkpoint_path /path/to/checkpoint/step-10800 --model_ref /path/to/exp/msgla-340M --tasks squad --max_samples 10
"""
