"""
eval_sfs.py — Zero-shot recall evaluation for GLA-family checkpoints in DCP format.
Evaluates on SWDE (Accuracy), FDA (Accuracy), and SQUAD (F1).

Examples:
    python eval_sfs.py --checkpoint_path /path/to/exp/gla-340M --step 10800 --model_ref /path/to/exp/gla-340M
    python eval_sfs.py --checkpoint_path /path/to/checkpoint/step-10800 --model_ref /path/to/exp/gla-340M --tasks squad --max_samples 10
"""
