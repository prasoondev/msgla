...
* Configurations that include scale `1` retain a native token-resolution branch; coarse-only ablations such as `[2, 4]` are also supported by the implementation.
